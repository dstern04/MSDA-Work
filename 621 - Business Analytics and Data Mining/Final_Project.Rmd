...
ggplot(tech_data, aes(x=year, y=IT.NET.USER.P2)) + geom_line() + 
  facet_wrap( ~ country) + theme_tufte() + scale_x_continuous(breaks = c(2005,2010,2015))
```
